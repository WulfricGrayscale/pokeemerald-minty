...
{
    [HEAL_LOCATION_LITTLEROOT_TOWN_PLAYERS_BEDROOM - 1] = {MAP_GROUP(LITTLEROOT_TOWN_PLAYERS_BEDROOM), MAP_NUM(LITTLEROOT_TOWN_PLAYERS_BEDROOM), 4, 2},
    ...
    [HEAL_LOCATION_LITTLEROOT_TOWN_PLAYERS_HOUSE - 1] = {MAP_GROUP(LITTLEROOT_TOWN), MAP_NUM(LITTLEROOT_TOWN), 23, 17},
    [HEAL_LOCATION_LITTLEROOT_TOWN_MAYS_HOUSE - 1] = {MAP_GROUP(LITTLEROOT_TOWN), MAP_NUM(LITTLEROOT_TOWN), 15, 13},
    ...
    [HEAL_LOCATION_DRAGON_VILLAGE - 1] = {MAP_GROUP(DRAGON_VILLAGE), MAP_NUM(DRAGON_VILLAGE), 14, 22},
};
