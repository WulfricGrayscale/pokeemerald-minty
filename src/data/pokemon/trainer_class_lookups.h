const u8 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_RIVAL_BRENDAN] = TRAINER_PIC_RIVAL_BRENDAN,
    [FACILITY_CLASS_RIVAL_MAY] = TRAINER_PIC_RIVAL_MAY,
};
...
const u8 gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_RIVAL_BRENDAN] = TRAINER_CLASS_RIVAL,
    [FACILITY_CLASS_RIVAL_MAY] = TRAINER_CLASS_RIVAL,
};
