...
const u16 gMetatiles_TrainingCenter[] = INCBIN_U16("data/tilesets/secondary/training_center/metatiles.bin");
const u16 gMetatileAttributes_TrainingCenter[] = INCBIN_U16("data/tilesets/secondary/training_center/metatile_attributes.bin");
