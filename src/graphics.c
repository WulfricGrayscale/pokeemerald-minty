...
const u16 gTitleScreenEmeraldVersionPal[]  = INCBIN_U16("graphics/title_screen/minty_emerald.gbapal");
...
const u32 gTitleScreenEmeraldVersionGfx[]  = INCBIN_U32("graphics/title_screen/minty_emerald_logo.8bpp.lz");
