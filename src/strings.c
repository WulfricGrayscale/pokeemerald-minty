...
const u8 gText_ExtraRerolls[] = _("EXTRA REROLLS");
...
const u8 gText_NoRerolls[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}NONE");
const u8 gText_GiftRerolls[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}GIFT");
