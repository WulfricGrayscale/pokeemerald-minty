...
const u8 gText_TrainingCenter[] = _("TRAINING CENTER");
...
const u8 gText_BaseOdds[] = _("SHINY ODDS");
const u8 gText_ExtraRerolls[] = _("GIFT REROLLS");
...
const u8 gText_ModernOdds[] = _("{COLOR GREEN}{ SHADOW LIGHT_GREEN}MODERN");
const u8 gText_ClassicOdds[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}CLASSIC");
const u8 gText_NoRerolls[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}OFF");
const u8 gText_GiftRerolls[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ON");
...
const u8 gText_ShinyPkmnsNickname[] = _("{STR_VAR_1}'s nickname?");
const u8 gText_ShinyNameFormatting[] = _("{COLOR RED}{SHADOW LIGHT_RED}");
